...
use crate::SPL_TOKEN_PROGRAM_ID;
...
impl ToAccountMetas for OracleHeartbeatAccounts {
    fn to_account_metas(&self, _: Option<bool>) -> Vec<AccountMeta> {
        ...
        let native_mint: Pubkey = crate::NATIVE_MINT.to_bytes().into();
        ...
        vec![
            ...
            AccountMeta::new_readonly(SPL_TOKEN_PROGRAM_ID.to_bytes().into(), false),
